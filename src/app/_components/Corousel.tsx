...
import image1 from '@public/images/djo3.jpg'
import image2 from '@public/images/djo2.jpg'
import image3 from '@public/images/djo1.jpg'
...
const Corousel = () => {
    ...
    return (
        <div className={cn('h-screen relative flex items-center',{'justify-center':image == 1})}>
            ...
            <div className={cn('relative px-32 text-white',{'text-center':image == 1})}>
                ...
                <button className='bg-blue-300 p-3 rounded-lg font-bold text-lg hover:border text-black'>SHOP NOW</button>
            </div>
        </div>
    )
}
